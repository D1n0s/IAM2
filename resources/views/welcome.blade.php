...
<div style="width: 100%;
    ...
    ">
        <form method="post" action="{{route('sort.sort')}}">
            @csrf
...
<div style="width: 100%;
    ...
    ">
    <form method="post" action="{{route('searchsize.searchsize')}}" >
        @csrf
        ...
        @foreach($d as $item)
            <div class="box">
                ...
                <div class="desc" style="width:70%; float:left;">
                    ...
                    <p style="color:blue; margin-top:0px; font-size: 14px;">{{ number_format($item['total_item_price'], 2) }} zł, w tym
                        <svg fill="blue" width="12" height="12" viewBox="0 0 16 16">
                            <path d="m7.34 8.3 3.56-3.58 1.07 1-4.62 4.67-2.89-2.82 1.06-1Zm7.33-5.9V8c0 5.6-6.67 8-6.67 8s-6.67-2.4-6.67-8V2.4L8 0Zm-1.5 1.05L8 1.59 2.83 3.45V8a6.31 6.31 0 0 0 2.76 4.92 13.09 13.09 0 0 0 2 1.28l.37.17.37-.17a13.09 13.09 0 0 0 2-1.28A6.31 6.31 0 0 0 13.17 8Z"></path>
                        </svg>
                    </p>
                    <p>{{ $item['size_title'] }}</p>
